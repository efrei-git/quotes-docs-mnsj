```bash
* 74fcb0c (HEAD -> main, origin/main, origin/HEAD) Refactor documentation and pushed log initiateur
*   5cabf90 Merge pull request #7 from jugurta12/main
|\
| * f68341d ajout du fichier .txt oublié
|/
*   3adef10 Merge pull request #6 from sarah387/main
|\
